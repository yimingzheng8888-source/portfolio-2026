...
export function SpecialProjectDetailPage(){
 ...
 return <article ref={root} className={`design-case ${isDrift?'drift-case':''}`} key={id}>
  ...
  <div className="case-container">
   ...
   {project.posters?.length? <section className="poster-appendix" id="project-posters" aria-labelledby="poster-title"><header className="poster-heading"><h2 id="poster-title">原始竞赛展板</h2><span>{project.posters.length} 张 · 点击放大</span></header><Gallery images={project.posters} title="完整展板" poster/></section>:null}
