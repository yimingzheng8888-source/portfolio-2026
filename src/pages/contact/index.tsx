...
export function ContactPage(){
  ...
  return <div className="section-shell contact-page"><header className="editorial-heading"><p>联系我</p><h1>从一次交流开始。</h1><p>欢迎交流船舶设计、技术与质量、验船及船东技术相关机会。</p></header>
    ...
    <div className="contact-return"><p>船舶与海洋设计 · 郑一鸣</p><Link to="/special-projects/drift-yacht">阅读 DRIFT 设计专题</Link></div>
  </div>;
}
